                          ...
                          <div class="col-xs-12 lenderFilters">
                              <div class="row">
                                  ...
                                  <div class="col-lg-9 col-sm-8 col-xs-12 reviewDetail">
                                      <p class="reviewTitle">Help when needed</p>
                                      <p class="reviewText">I was in a real bad spot and Upstart provided me a way out of my situation without needing collateral.  I will forever be grateful.  Thank you so much. </p>
                                                                      <div class="hideText" aria-hidden="true">
                                          <p class="consumerName">Marcus                                                                        <span>from Kyle,  TX</span></p>
                                                                              <p class="consumerReviewDate">Reviewed in November 2021</p>
                                      </div>

                                      <div class="helpfull-count desktop-view">
                                          <div class="helpfull-section">
                                              <input type="hidden" class="reviewId" name="reviewId" value="618d1a821567864efb5543f6">
                                                                                      <div class="flagged-review">
                                                  <button class="a11y-modal-trigger flag" data-target="flag-618d1a821567864efb5543f6" aria-label="Mark this review as flagged">
                                      ...
                                      <div class="hideText">
                                          ...
                                          <div class="helpfull-count mobile-view">
                                              <div class="helpfull-section">
                                                  <input type="hidden" class="reviewId" name="reviewId" value="618d1a821567864efb5543f6">
                                                                                          <div class="flagged-review">
                                                      <button class="flag" id="m-flag-618d1a821567864efb5543f6" aria-label="Mark this review as flagged" aria-expanded='false'>
                                                  ...
                                                  <div class="review-flag" id="m-review-flag-618d1a821567864efb5543f6" aria-hidden='true'>
